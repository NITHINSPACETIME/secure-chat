...
export function CreateAccountFlow({
  ...
  const copyToClipboard = () => {
    ...
    toast({
      ...
      description: "Store this safely offline!",
    });
        ...
        <div className="flex items-center justify-between">
          <Button
            ...
            onClick={
              step === "name"
                ? onBack
                : () => setStep(step === "confirm" ? "recovery" : "name")
            }
              ...
              <div className="space-y-6">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    This is how you will be identified on the network.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label
                      htmlFor="name"
                      className="text-xs font-bold uppercase text-muted-foreground tracking-wider ml-1"
                    >
                      Display Name
                    </Label>
                    <Input
                    ...
                    />
                    {nameError && (
                      <p className="text-destructive text-sm font-medium flex items-center gap-1 pl-1">
                  ...
                  <Button
                    ...
                    className="w-full h-14 text-base rounded-xl font-semibold shadow-lg shadow-primary/20"
                  >
                    {isChecking ? (
              ...
              <div className="space-y-6">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm">
                    This 12-word phrase is the <strong>only</strong> way to
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex gap-3 items-start text-amber-600 dark:text-amber-400 text-sm">
                  ...
                  <p>
                    If you lose this phrase, you lose your account forever. We
                ...
                <div className="pt-2">
                  ...
                  >
                    <Checkbox
                      ...
                      onCheckedChange={(c) => setHasWrittenDown(!!c)}
                    />
                    <label
                      htmlFor="confirm"
                  ...
                  <Button
                    ...
                    className="w-full h-14 text-base mt-4 rounded-xl font-semibold"
                    size="lg"
                  >
            ...
            {step === "confirm" && (
              <div className="space-y-8 text-center py-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Your cryptographic vault has been created successfully.
                  </p>
                </div>
                ...
                <Button
                  ...
                  className="w-full h-14 text-lg rounded-xl font-bold shadow-xl shadow-primary/20"
                  size="lg"
                >
                  Enter Project Nyx
                </Button>
